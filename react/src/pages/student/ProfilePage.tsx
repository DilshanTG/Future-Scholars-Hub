...
export default function StudentProfilePage() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <div className="gradient-welcome rounded-2xl p-6 text-white mb-4 flex items-center gap-4">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        ...
        <form onSubmit={handleChangePassword} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input type="password" value={newPw} onChange={(e) => setNewPw(e.target.value)} required className="rounded-xl" placeholder="Min 6 characters" />
          </div>
          <div className="space-y-2">
