<?php
// flight_app/views/teacher/add_recording.php
?>
<style>
    .dashboard-header {
        background: white;
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="d-flex align-items-center mb-4">
                    <a href="/online_class/flight_app/teacher/recordings" class="btn btn-light rounded-circle me-3 shadow-sm"
                        style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                        ←
                    </a>
                    <h2 class="fw-bold mb-0">Add Recording 🎥</h2>
                </div>

                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        <form method="POST" action="/online_class/flight_app/teacher/recordings/add">
                            <div class="mb-3">
                                <label class="form-label fw-bold">Topic *</label>
                                <input type="text" name="topic" class="form-control form-control-lg"
                                    placeholder="e.g., Math - Fractions" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary btn-lg">Add Recording</button>
                                <a href="/online_class/flight_app/teacher/recordings" class="btn btn-light btn-lg">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
