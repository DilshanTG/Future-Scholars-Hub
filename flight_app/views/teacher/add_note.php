<?php
// flight_app/views/teacher/add_note.php
?>
<style>
    .dashboard-header {
        background: white;
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="d-flex align-items-center mb-4">
                    <a href="/online_class/flight_app/teacher/notes" class="btn btn-light rounded-circle me-3 shadow-sm"
                        style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                        ←
                    </a>
                    <h2 class="fw-bold mb-0">Add New Note 📝</h2>
                </div>

                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        <form method="POST" action="/online_class/flight_app/teacher/notes/add">
                            <div class="mb-3">
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold">Link (Google Drive/PDF) - Optional</label>
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <a href="/online_class/flight_app/teacher/notes" class="btn btn-light btn-lg">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
