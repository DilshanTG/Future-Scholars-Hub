            ...
            <div class="col-md-8">
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-4">
                        <h3 class="fw-bold mb-4">Assign Notes to Student</h3>
                        <form method="POST" action="/online_class/flight_app/teacher/students/assign-note/<?= $studentId ?>">
                            <div class="list-group mb-4" style="max-height: 400px; overflow-y: auto;">
                                <?php foreach ($notes as $note): ?>
                                    <label class="list-group-item d-flex gap-2">
                                        <input class="form-check-input flex-shrink-0" type="checkbox" name="note_ids[]" value="<?= $note['id'] ?>">
                                        <span>
