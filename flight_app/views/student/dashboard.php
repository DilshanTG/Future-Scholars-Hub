<?php
// flight_app/views/student/dashboard.php
?>
<style>
    .dashboard-header {
        background: white;
    ...
    <nav class="navbar navbar-expand-lg dashboard-header">
        <div class="container">
            <a class="navbar-brand fw-bold text-primary fs-4" href="/online_class/flight_app/student/dashboard">
                <span class="me-2"><?= $student['avatar'] ?></span>Future Scholars
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto gap-2">
                    <li class="nav-item"><a class="nav-link active"
                            href="/online_class/flight_app/student/dashboard">Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link" href="/online_class/flight_app/student/classes">Classes
                            📚</a></li>
                    <li class="nav-item"><a class="nav-link" href="/online_class/flight_app/student/notes">Notes 📝</a>
                    </li>
                    <li class="nav-item"><a class="nav-link"
                            href="/online_class/flight_app/student/recordings">Recordings 🎥</a></li>
                    <li class="nav-item"><a class="nav-link"
                            href="/online_class/flight_app/student/announcements">News 📢</a></li>
                    <li class="nav-item"><a class="nav-link text-danger"
                            href="/online_class/flight_app/logout">Logout 🚪</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container pb-5">
                            ...
                            <div class="alert alert-warning announcement-alert fade show mb-2" role="alert">
                                <div class="d-flex justify-content-between align-items-start">
                                    ...
                                    <?php if ($announcement['expire_date']): ?>
                                        <small class="text-muted" style="font-size: 0.75rem;">Expires:
                                            <?= date('M d', strtotime($announcement['expire_date'])) ?></small>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="text-muted fs-5 mb-3">
                                📅 <?= date('l, F jS', strtotime($nextClass['class_date'])) ?> at
                                <?= date('g:i A', strtotime($nextClass['class_date'])) ?>
                            </p>
                            <div class="d-flex gap-2">
                                <span class="badge bg-light text-dark border">Online Class</span>
                            </div>
                        </div>
                        <div class="col-md-4 text-md-end mt-3 mt-md-0">
                            <?php if ($nextClass['zoom_link']): ?>
                                <a href="<?= $nextClass['zoom_link'] ?>" target="_blank" class="btn btn-primary btn-lg px-4 shadow-sm">
                                    🎥 Join Class
                                </a>
                            <?php else: ?>
        ...
        <?php else: ?>
            <div class="alert alert-danger rounded-4 p-4">
                ...
                <p class="mb-0">Your account is currently inactive. Please ask your parent to contact the teacher!</p>
            </div>
        <?php endif; ?>
