<?php
// flight_app/views/student/notes.php
?>
<style>
    .dashboard-header {
        background: white;
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto gap-2">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="/online_class/flight_app/student/notes">Notes 📝</a></li>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body p-4">
                            ...
                            <small class="text-muted d-block mb-3">📅 <?= date('M d, Y', strtotime($note['created_at'])) ?></small>
                            <?php if ($note['details']): ?>
                                <p class="text-muted mb-3 small"><?= $note['details'] ?></p>
                            <?php endif; ?>
                            
                            <?php if ($note['link']): ?>
                                <a href="<?= $note['link'] ?>" target="_blank" class="btn btn-outline-primary w-100">
                                    Open Note 📄
                                </a>
                            <?php else: ?>
                                <button disabled class="btn btn-light w-100 text-muted">No Link</button>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
