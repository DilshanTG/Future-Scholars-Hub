...
<head>
    ...
    <title>Students - Future Scholars Hub</title>
    <!-- Google Fonts -->
    ...
    <div class="container-fluid px-0">
        ...
        <div class="container pb-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="/teacher/students/add" class="btn btn-primary d-none d-md-inline-block">Add New Student</a>
            </div>
                            ...
                            <tbody>
                                <?php foreach (($students?:[]) as $student): ?>
                                    <tr data-grade="<?= ($student['grade']) ?>" data-status="<?= ($student['status']) ?>"
                                        ...
                                        <td>
                                            <a href="/teacher/students/view/<?= ($student['id']) ?>"
...
" ?>
                                        ...
                                        <td>
                                            <?php if ($student['next_class']): ?>
                                                    ...
                                                    <div class="small text-muted"><?= (date('M d, H:i',
                                                        strtotime($student['next_class']['class_date']))) ?></div>
                                        ...
                                        <td class="text-end pe-4">
                                            <div class="btn-group">
                                                <a href="/teacher/students/edit/<?= ($student['id']) ?>"
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item"
                                                            href="/teacher/students/assign-note/<?= ($student['id']) ?>">Assign
                                                            Note</a></li>
                                                    <li><a class="dropdown-item"
                                                            href="/teacher/students/assign-class/<?= ($student['id']) ?>">Assign
                                                            Class</a></li>
                                                </ul>
                                            </div>
                                        </td>
...
" ?>
                        ...
                        <?php if ($student['next_class']): ?>
                                ...
                                <div class="alert alert-light border p-2 mb-0 mt-2">
                                    ...
                                    <small class="d-block text-muted"><?= (date('M d, H:i',
                                        strtotime($student['next_class']['class_date']))) ?></small>
                                </div>
                        ...
                        <div class="list-card-actions">
                            ...
                            <div class="dropdown flex-grow-1 d-grid">
                                ...
                                <ul class="dropdown-menu w-100">
                                    <li><a class="dropdown-item"
                                            href="/teacher/students/assign-note/<?= ($student['id']) ?>">Assign Note</a></li>
                                    <li><a class="dropdown-item"
                                            href="/teacher/students/assign-class/<?= ($student['id']) ?>">Assign Class</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <a href="/teacher/students/add" class="fab-btn d-md-none">
                +
            </a>
        </div>
    </div>
