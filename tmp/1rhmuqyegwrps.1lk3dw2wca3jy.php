...
<head>
    ...
    <title>Assign Note - Future Scholars Hub</title>
    <!-- Google Fonts -->
    ...
    <div class="container-fluid px-0">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto gap-2">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/teacher/recordings">Recordings 🎥</a>
                        </li>
        ...
        <div class="container pb-5">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h2 class="fw-bold mb-0">Assign Note 📝</h2>
                    <p class="text-muted mb-0">Select students for <strong><?= ($note['title']) ?></strong></p>
                </div>
            </div>
            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body p-4">
                    <h4 class="fw-bold text-primary mb-3"><?= ($note['title']) ?></h4>
                    <?php if ($note['link']): ?>
                        
                            <a href="<?= ($note['link']) ?>" target="_blank" class="text-decoration-none"><?= ($note['link']) ?></a>
            ...
            <form method="POST" action="/teacher/notes/assign/<?= ($note['id']) ?>" id="assignForm">
                <!-- Student Grid -->
        ...
        <div class="sticky-action-bar">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex gap-2">
                    <a href="/teacher/notes" class="btn btn-light btn-lg px-4">Cancel</a>
