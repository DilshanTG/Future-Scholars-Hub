...
<head>
    ...
    <title>Assign Recording - Future Scholars Hub</title>
    <!-- Google Fonts -->
    ...
    <div class="container-fluid px-0">
        ...
        <div class="container pb-5">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h2 class="fw-bold mb-0">Assign Recording 🎥</h2>
                    <p class="text-muted mb-0">Select students for <strong><?= ($recording['topic']) ?></strong></p>
                </div>
            </div>
            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body p-4">
                    <h4 class="fw-bold text-primary mb-3"><?= ($recording['topic']) ?></h4>
                    <div class="d-flex align-items-center mb-2">
                        <span class="me-2">🔗</span>
                        <a href="<?= ($recording['link']) ?>" target="_blank" class="text-decoration-none"><?= ($recording['link']) ?></a>
                    </div>
                    <?php if ($recording['description']): ?>
                        
                            <div class="mt-2">
                                <span class="me-2">📝</span>
                                <span class="text-muted"><?= ($recording['description']) ?></span>
                            </div>
            ...
            <form method="POST" action="/teacher/recordings/assign/<?= ($recording['id']) ?>" id="assignForm">
                <!-- Student Grid -->
        ...
        <div class="sticky-action-bar">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex gap-2">
                    <a href="/teacher/recordings" class="btn btn-light btn-lg px-4">Cancel</a>
