...
<head>
    ...
    <title>Add Announcement - Future Scholars Hub</title>
    <!-- Google Fonts -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="d-flex align-items-center mb-4">
                        <a href="/teacher/announcements" class="btn btn-light rounded-circle me-3 shadow-sm"
                    ...
                    <form method="POST" action="/teacher/announcements/add" id="announcementForm">
                        <div class="row g-4">
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-grid gap-2">
                                            <button type="submit" class="btn btn-primary btn-lg">Post Announcement
                                                📢</button>
                                            <a href="/teacher/announcements" class="btn btn-light btn-lg">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
